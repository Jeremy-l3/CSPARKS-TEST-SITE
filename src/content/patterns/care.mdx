...
title: Care
summary: >
  Actively demonstrate care as a foundational precondition for trust—not as
  sentiment, but as behavior—by holding space for truth, acknowledging harm,
  and staying in sustained relationship through discomfort.
status: draft
tags:
  - deepening-trust
  - repair
  - relationship
forces:
  - harm-makes-trust-dangerous
  - power-makes-care-conditional
  - resistance-to-acknowledging-harm
  - repair-vs-efficiency
  - respecting-pace-of-engagement
related:
  - appreciation
  - openness
  - reliability
...
- **Harm Makes Trust Dangerous**: People who have experienced harm may not feel safe opening up
- **Power Makes Care Conditional**: Power dynamics can make care feel conditional or strategic rather than sincere
- **Resistance to Acknowledging Harm**: Those who have benefited from unjust systems may resist acknowledging harm or responsibility
- **Repair vs. Efficiency**: Repair work can be emotionally demanding and long-term—making short-term efficiency incompatible with justice
- **Respecting Pace of Engagement**: People need space to engage at their own pace, without coercion
...
- Begin repair work by listening, not proposing solutions
- Create structures for ongoing relationship, not one-time conversations
- Name what you care about beyond the immediate task
- Take responsibility for past harms without requiring forgiveness
- Make "no" a safe and honored response

## Examples

- A community process that begins with a listening session for those most impacted
- An organization that acknowledges its historical complicity before asking for partnership
- A facilitator who checks in on participants' wellbeing, not just task completion

## Failure Modes

- **Performative care**: Going through the motions without genuine attention
- **Care as control**: Using care to create obligation or dependency
- **Rushing repair**: Expecting quick resolution of deep wounds
- **Care without accountability**: Being warm without taking responsibility for harm
